...
> **Objetivos:** Consolidar transição para Full Stack para Cloud-Native Developer
...
Como projeto **Full Stack**, integra uma experiência de usuário fluida com infraestrutura robusta e automatizada na AWS, resolvendo o gargalo de processamento de grandes volumes de dados através de arquitetura baseada em eventos.
