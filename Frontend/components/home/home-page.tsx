...
export function HomePage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (pricing && scrollPosition >= pricing.offsetTop) {
        setActiveSection("pricing");
      } else if (useCases && scrollPosition >= useCases.offsetTop) {
              ...
              <a
                ...
                className={`text-sm px-3 py-2 rounded transition-all cursor-pointer ${
                  activeSection === "features"
                    ...
                    : `text-foreground hover:text-black hover:bg-primary`
                }`}
              >
                Recursos
              </a>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden pb-4 space-y-3">
              <a
                ...
                className={`block text-sm px-3 py-2 rounded transition-all cursor-pointer ${
                  activeSection === "features"
                    ? "bg-primary text-primary-foreground font-medium"
                    : "text-foreground hover:text-black hover:bg-primary"
                }`}
