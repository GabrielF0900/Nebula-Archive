  ...
  return (
    <div className="w-full max-w-md mx-auto relative">
      <div className="glass rounded-lg p-8 space-y-8 relative">
        ...
        <button
          onClick={() => navigate("/")}
          className="absolute top-0 left-0 flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground hover:bg-primary hover:text-primary-foreground px-2 py-1 rounded-br transition-all"
        >
