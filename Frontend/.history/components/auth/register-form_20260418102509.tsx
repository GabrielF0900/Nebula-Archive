  ...
  return (
    <div className="w-full max-w-md mx-auto relative">
      <div className="glass rounded-lg p-4 space-y-2 relative">
        ...
        <button
          onClick={() => navigate("/")}
          className="absolute top-2 -left-32 flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground hover:bg-primary hover:text-primary-foreground px-2 py-1 rounded transition-all"
        >
