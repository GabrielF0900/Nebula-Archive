  ...
  return (
    <div className="w-full max-w-md mx-auto relative">
      <div className="glass rounded-lg p-8 space-y-6 relative">
        ...
        <button
          onClick={() => navigate("/")}
          className="absolute -top-12 left-0 flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground hover:bg-card/50 px-3 py-2 rounded transition-all"
        >
