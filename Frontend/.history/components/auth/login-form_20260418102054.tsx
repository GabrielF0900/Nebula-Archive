...
export function LoginForm({
  ...
  return (
    <>
      {/* Botão movido para fora da div principal do formulário.
          Usando 'fixed' para prende-lo no canto superior da metade direita da tela.
          Ajuste top-10 e left-[52vw] conforme necessário para alinhar com o círculo. */}
      <button
        onClick={() => navigate("/")}
        className="fixed top-12 left-[55vw] flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground hover:bg-primary/10 hover:text-primary px-3 py-2 rounded transition-all z-50 md:flex hidden"
      >
