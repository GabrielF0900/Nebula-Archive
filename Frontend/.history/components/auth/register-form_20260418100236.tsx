...
export function RegisterForm({ onSwitchToLogin }: RegisterFormProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto relative">
      <div className="glass rounded-lg p-6 space-y-4 relative">
        {/* Home Button - Top Left */}
        <button
          onClick={() => navigate("/")}
          className="absolute -top-8 -left-16 flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground hover:bg-primary hover:text-primary-foreground px-3 py-2 rounded transition-all"
        >
