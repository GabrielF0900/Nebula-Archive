...
export function LoginForm({
  ...
  return (
    <div className="w-full max-w-md mx-auto relative">
      ...
      {/* Home Button - Posicionado com um leve recuo (left-6) e flutuando acima do form (mt-8) */}
      <button
        onClick={() => navigate("/")}
        className="absolute top-0 left-6 flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground hover:bg-primary/10 hover:text-primary px-2 py-1 rounded transition-all md:flex hidden" 
      >
      ...
      <div className="glass rounded-lg p-8 space-y-8 relative mt-10">
        {/* Header */}
