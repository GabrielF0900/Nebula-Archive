          ...
          {activeSection === "distribution" && (
            <div className="glass-light rounded-lg p-6 border border-border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  { code: "GRU", name: "São Paulo", status: "active", latency: "12ms" },
                  { code: "IAD", name: "Virginia", status: "active", latency: "89ms" },
                  { code: "FRA", name: "Frankfurt", status: "active", latency: "145ms" },
                  { code: "NRT", name: "Tokyo", status: "active", latency: "215ms" },
                  { code: "SYD", name: "Sydney", status: "active", latency: "280ms" },
                  { code: "CDG", name: "Paris", status: "active", latency: "152ms" },
                ].map((location) => (
                  <div
                    key={location.code}
            ...
            <div className="glass-light rounded-lg p-6 border border-border">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { name: "Lambda Processing", status: "operational", uptime: "99.95%" },
                  { name: "CloudFront CDN", status: "operational", uptime: "100%" },
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="text-xs text-success font-medium">Operacional</p>
