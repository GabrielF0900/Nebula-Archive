  ...
  const features = [
    {
      ...
      description: "CDN em 200+ edge locations para acesso rápido em qualquer lugar",
    },
    {
      icon: Zap,
  ...
  const useCases = [
    {
      ...
      description: "Entregue conteúdo de vídeo de alta qualidade com transcodificação automática",
    },
    {
    ...
    },
    {
      ...
      description: "Extraia metadados e insights de seus arquivos automaticamente",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Infraestrutura serverless de classe mundial para processar, armazenar e distribuir seus arquivos de mídia com segurança e velocidade.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
            ...
            <Button
              variant="outline"
              className="border-border hover:bg-muted h-12 px-8 text-base font-medium"
            >
              Ver Demo
            </Button>
          </div>
